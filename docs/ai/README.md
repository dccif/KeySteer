...
| 修改 Window 库存生命周期、稳定编号、即时布局/BSP 编辑、Tab 或撤销 | [模式状态机](04-modes-and-lifecycle.md)、[窗口请求 API](02-runtime-and-api.md)、[配置](03-configuration.md)、[原生后端](06-platform-backends.md)、[验证](08-build-docs-and-tests.md) |
...
| 修改统一 presentation、视图端口、覆盖层、实时按键提示、Window 锚定面板及其缓存、帧时钟或性能 | [覆盖层、帧同步与性能](07-rendering-and-performance.md) |
